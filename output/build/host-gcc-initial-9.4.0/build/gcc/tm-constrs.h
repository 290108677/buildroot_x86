...
#line 175 "../../gcc/config/i386/constraints.md"
...
satisfies_constraint_Bs (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return ((!(
#line 183 "../../gcc/config/i386/constraints.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 184 "../../gcc/config/i386/constraints.md"
...
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 192 "../../gcc/config/i386/constraints.md"
(TARGET_X32))) && (memory_operand (op, mode)))) || ((
#line 194 "../../gcc/config/i386/constraints.md"
(TARGET_X32 && Pmode == DImode)) && (GOT_memory_operand (op, mode)));
}
static inline bool
...
satisfies_constraint_C (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (
#line 258 "../../gcc/config/i386/constraints.md"
