...
{
  return ((GET_CODE (op) == REG) && (
#line 55 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 60 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 65 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 70 "../../gcc/config/i386/predicates.md"
(QI_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((
#line 74 "../../gcc/config/i386/predicates.md"
...
(TARGET_64BIT)) && (
#line 92 "../../gcc/config/i386/predicates.md"
(GET_MODE (op) == DImode))) || ((
...
{
  return (
#line 122 "../../gcc/config/i386/predicates.md"
...
#line 259 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
#line 350 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && ((!(
#line 398 "../../gcc/config/i386/predicates.md"
(TARGET_64BIT))) || ((
#line 399 "../../gcc/config/i386/predicates.md"
(ix86_cmodel == CM_SMALL)) || (
#line 400 "../../gcc/config/i386/predicates.md"
(ix86_cmodel == CM_KERNEL))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 421 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 428 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 435 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 444 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 452 "../../gcc/config/i386/predicates.md"
...
#line 469 "../../gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 497 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 541 "../../gcc/config/i386/predicates.md"
{
...
{
  return (!(
#line 583 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 589 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 593 "../../gcc/config/i386/predicates.md"
...
tls_address_pattern (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 597 "../../gcc/config/i386/predicates.md"
...
#line 617 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 631 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
#line 644 "../../gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
  if (reload_completed)
...
{
  return (register_operand (op, mode)) || ((!(
#line 668 "../../gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 669 "../../gcc/config/i386/predicates.md"
...
#line 699 "../../gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
...
#line 712 "../../gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && (((!(
#line 713 "../../gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))) || ((
#line 715 "../../gcc/config/i386/predicates.md"
...
#line 756 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 761 "../../gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 771 "../../gcc/config/i386/predicates.md"
...
#line 785 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 1 || i == 2 || i == 3;
}
...
#line 793 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 801 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 809 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
#line 817 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || (i >= 8 && i <= 11);
}
...
(op == const0_rtx)) || (
#line 834 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 839 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 849 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 854 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 869 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 894 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 904 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 914 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 919 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 924 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 929 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 934 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 939 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 944 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 949 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 954 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 969 "../../gcc/config/i386/predicates.md"
...
#line 979 "../../gcc/config/i386/predicates.md"
{
...
#line 991 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 992 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx)))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
{
  return (
#line 996 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 1001 "../../gcc/config/i386/predicates.md"
...
#line 1030 "../../gcc/config/i386/predicates.md"
(INTEGRAL_MODE_P (GET_MODE (op)))) && (
#line 1031 "../../gcc/config/i386/predicates.md"
...
(TARGET_AVX)) || (
#line 1038 "../../gcc/config/i386/predicates.md"
...
{
  return (memory_operand (op, mode)) && (!(
#line 1068 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 1078 "../../gcc/config/i386/predicates.md"
...
#line 1097 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
#line 1202 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1214 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1239 "../../gcc/config/i386/predicates.md"
{
...
#line 1285 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1328 "../../gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1354 "../../gcc/config/i386/predicates.md"
...
#line 1395 "../../gcc/config/i386/predicates.md"
...
#line 1412 "../../gcc/config/i386/predicates.md"
{
...
#line 1436 "../../gcc/config/i386/predicates.md"
...
#line 1441 "../../gcc/config/i386/predicates.md"
...
#line 1446 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  int swapped;
  HOST_WIDE_INT mask;
...
#line 1482 "../../gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  bool swapped;
  int nunits, elt;
...
#line 1513 "../../gcc/config/i386/predicates.md"
{
...
#line 1545 "../../gcc/config/i386/predicates.md"
{
...
#line 1561 "../../gcc/config/i386/predicates.md"
{
...
#line 1576 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT val = INTVAL (op);
...
{
  return (register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 1591 "../../gcc/config/i386/predicates.md"
(op == constm1_rtx))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
#line 1597 "../../gcc/config/i386/predicates.md"
{
...
#line 1638 "../../gcc/config/i386/predicates.md"
{
  const unsigned len = XVECLEN (op, 0);
  unsigned i;
...
(IN_RANGE (ival, -128, 127));
    ...
    case CONSTRAINT_L:
      return 
#line 227 "../../gcc/config/i386/constraints.md"
(ival == 0xff || ival == 0xffff
		    || ival == (HOST_WIDE_INT) 0xffffffff);

    case CONSTRAINT_M:
      return 
#line 233 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3));

    case CONSTRAINT_N:
      return 
#line 239 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255));
