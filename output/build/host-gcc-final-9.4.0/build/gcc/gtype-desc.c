	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_arch_string), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_recip_name), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_ctrl_string), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_memcpy_strategy), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_memset_strategy), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_string), cookie);
}
