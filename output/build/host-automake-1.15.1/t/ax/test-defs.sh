...
am_rel_srcdir='.'
am_top_srcdir='/root/buildroot-2021.05.1/output/build/host-automake-1.15.1'
am_top_builddir='/root/buildroot-2021.05.1/output/build/host-automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/root/buildroot-2021.05.1/output/host/share/automake-1.15/am'
    am_automake_acdir='/root/buildroot-2021.05.1/output/host/share/aclocal-1.15'
    am_bindir='/root/buildroot-2021.05.1/output/host/bin'
    am_datadir='/root/buildroot-2021.05.1/output/host/share'
    am_docdir='/root/buildroot-2021.05.1/output/host/share/doc/automake'
    am_pkgvdatadir='/root/buildroot-2021.05.1/output/host/share/automake-1.15'
    am_scriptdir='/root/buildroot-2021.05.1/output/host/share/automake-1.15'
    am_system_acdir='/root/buildroot-2021.05.1/output/host/share/aclocal'
    ;;
  no)
...
YACC=${AM_TESTSUITE_YACC-${YACC-'false'}}
LEX=${AM_TESTSUITE_LEX-${LEX-'false'}}
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/root/buildroot-2021.05.1/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/root/buildroot-2021.05.1/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/root/buildroot-2021.05.1/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/root/buildroot-2021.05.1/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/root/buildroot-2021.05.1/output/host/include'}}
